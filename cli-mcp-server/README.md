...
3. Publish to PyPI:
   ...
   ```bash
   uv publish --token {{pypi-AgEIcHlwaS5vcmcCJGYzOTcxZWRkLWJiMzItNGE4Mi05OTczLTk2NGE2ZTIyMDE1ZQACKlszLCJiOWRmYjcwMy00MzU4LTRiYjgtODg5Zi04Yzk5YmMwN2JkZWEiXQAABiDPK7wMeJcyJBoK_MpuxhHqEhZe79_wZNT4GuZLswtoig}}
   ```
